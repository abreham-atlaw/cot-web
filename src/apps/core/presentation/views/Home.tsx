	...
	const about = [
		{
			...
			desc: <TranslatedText text="The assets that are owned by the company are effectively managed." />,
			icons: <IoCloudDownload />,
		},
		{
			title: <TranslatedText text="Tracking Company Assets" />,
			desc: <TranslatedText text="The realtime location of an asset at a fingerytip." />,
			icons: <BsPersonFillGear />,
		},
		{
			title: <TranslatedText text="Managing requests" />,
			desc: <TranslatedText text="Assosciates/ employees of the company can request for an assets in an efecient manner." />,
			icons: <MdMiscellaneousServices />,
		},
	];
	const footer = [<TranslatedText text="Services" />, <TranslatedText text="Guidelines" />, <TranslatedText text="Community" />];
	const footerCol2 = [<TranslatedText text="Facebook" />, <TranslatedText text="Instagram" />, <TranslatedText text="LInkedin" />];
	return (
		<>
			<NavBar />
			<div className='home' id='home'>
				<div className='content'>
					<div className='part1'>
						<h4> <TranslatedText text="Accelerated solution" /> </h4>
						<ul>
						...
						<a href='/admin'>
							<button>
								<p><TranslatedText text="More about us" /></p>
				...
				<div className='services' id='services'>
					...
					<div className='content'>
						<h2 style={{fontFamily:'"Lobster", cursive',}}> <TranslatedText text="Our Goals" /></h2>
						<p>
				...
				<h1 className='about-title'> <TranslatedText text="About us" /> </h1>
				<div className='about' id='about'>
					<div className='col'>
						<div className='img-container'>
							<img src={image2} alt='column' />
						</div>
						<p> <TranslatedText text="Solution to management problems" /></p>
					</div>
					<div className='lists'>
						{about.map((item) => (
							<div className='map'>
				...
				<div className='footer'>
					<div className='footerContent'>
						<div className='footerSection1'>
							<div className='footerLogo'>
								<h1> <TranslatedText text="Chain of trust" /></h1>
							</div>
						...
						<ul className='footermenu'>
							<li>
								<a href='/'> <TranslatedText text="Home" /></a>
							</li>
							<li>
								<a href='/services'> <TranslatedText text="Services" /></a>
							</li>
							<li>
								<a href='/about'> <TranslatedText text="About" /></a>
							</li>
						</ul>
						<div className='footerSection2'>
							<div className='col'>
								<h2> <TranslatedText text="Info" /> </h2>
								{footer.map((item) => (
							...
							<div className='col'>
								<h2> <TranslatedText text="Socials" /> </h2>
								{footerCol2.map((item) => (
									<div className='columns'>
										<div className='col1'> {item}</div>
									</div>
					...
					<div className='footerText'style={{fontFamily:'times'}}>
						© 2023 <TranslatedText text="Chain Of turst. All rights reserved." />
					</div>
				</div>
			</div>
		</>
