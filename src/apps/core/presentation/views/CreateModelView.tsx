...
export class EditModelInnerView<
  M extends EtherModel,
  F extends Form
> extends ViewModelView<
  EditModelViewModel<M, F>,
  EditModelViewProps<M, F>,
  EditModelState<M, F>
> {
  onCreateViewModel(state: EditModelState<M, F>): EditModelViewModel<M, F> {
...
function EditModelView<M extends EtherModel, F extends Form>(
  props: Omit<EditModelViewProps<M, F>, "id">
) {
